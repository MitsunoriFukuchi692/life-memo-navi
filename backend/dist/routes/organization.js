        ...
        for (const member of members) {
            ...
            try {
             ...
             VALUES ($1, $2, $3, $4, NOW())`, [org.id, userId, name.trim(), email.trim().toLowerCase()]);
                    ...
                    const newUser = await pool.query(`INSERT INTO users (name, email, password, created_at, updated_at)
             VALUES ($1, $2, $3, NOW(), NOW())
             RETURNING id`, [name.trim(), email.trim().toLowerCase(), hashedPassword]);
