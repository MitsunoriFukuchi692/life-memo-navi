...
export const JIBUNSHI_QUESTION_HINTS: Record<number, string[]> = {
  1: [ // 生まれた時代
    '🗺️ あなたが生まれた頃、どんなニュースがあったか覚えていますか？',
    '📻 その頃ラジオやテレビで流行っていた歌は何でしたか？',
    '🍚 子どもの頃、食卓によく出ていた料理は何ですか？',
  ],
  2: [ // 生まれた場所・幼い頃
    '🏠 どんな家に住んでいましたか？（土間・畳・縁側など）',
    '👶 近所の子と何をして遊びましたか？（めんこ・石蹴り・川遊びなど）',
    '🌾 幼い頃の季節の思い出（お祭り・田植え・雪遊びなど）はありますか？',
  ],
  3: [ // 家族
    '👨‍👩‍👧‍👦 ご兄弟は何人いましたか？上か下か、どんな関係でしたか？',
    '👴 おじいちゃん・おばあちゃんとの思い出はありますか？',
    '🏡 お父さん・お母さんはどんなお仕事をしていましたか？',
  ],
  4: [ // 学生時代
    '🏫 小学校・中学校の担任の先生で印象に残っている方はいますか？',
    '⚾ 部活動や放課後の過ごし方を教えてください',
    '📚 得意な科目・苦手な科目はありましたか？',
    '🎵 学校の音楽の授業や合唱で歌った曲を覚えていますか？',
  ],
  5: [ // 最初の職場
    '🚂 就職先はどうやって決めましたか？（就職活動・縁故・集団就職など）',
    '💼 初めて給料をもらった時の気持ちを覚えていますか？',
    '🏢 最初の上司や先輩はどんな方でしたか？',
  ],
  6: [ // 大きな決断
    '💍 結婚を決めたきっかけは何でしたか？',
